...
RUN apt update && \
    ...
    wget -q --directory-prefix=/etc/apt/trusted.gpg.d/google-chrome https://dl.google.com/linux/linux_signing_key.pub | gpg --dearmor /etc/apt/trusted.gpg.d/google-chrome && \
